...
OUTPUT_DIR = \
    "../../out/fall2017/perflow_queue_first_packet_slo_exponential_lognormal_exponential_scan"
...
def main():
    ...
    host_types = ['perflow']
    deq_costs = [0.0]
    queue_policies = ['FirstPacketLatencyDequeuePolicy']
    ...
    for i in loads:
        ...
        temp_conf[0]["load"] = i / 3.0
        temp_conf[1]["load"] = i / 3.0
        temp_conf[2]["load"] = i / 3.0
